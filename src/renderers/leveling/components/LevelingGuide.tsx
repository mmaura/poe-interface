...
export function ZoneMenu() {
  return (
    <div className="flex flex-col">
      ...
      <button className="bg-poe-96 border-poe-4 p-2 shadow-xl rounded-lg h-10 overflow-hidden mb-1 disabled">
        Modifier le set
      </button>
      ...
      <ul className="tips text-sm mt-2">
        ...
        <li>Leaving Izaro lieutenants alive gives you more keys at the end</li>
        <li>
        ...
        <li>
          ...
          Whetstone + weapon = Magic same weapon type with (40 to 64%) Increased
          Physical Damage
        </li>
        <li>
          Sell to the vendor a Chain Belt (magix or rare) + Blacksmith Whetstone
          + Dagger/Sceptre/Staff/Wand = Magic same weapon with (10 to 29%)
          Increased Spell Damage
        </li>
        <li>
          Sell to a vendor Magic Sceptre/Wand/Rune Dagger + Ruby Ring(for Fire
          Damage) or Topaz Ring(for Lightning Damage) or Sapphire Ring(for Cold
          Damage) + Orb of Alteration = Weapon with with added x to x
