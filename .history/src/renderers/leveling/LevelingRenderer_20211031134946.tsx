...
function App(props: { Init: any }) {
  ...
  else return <p>`L'ActsGuide ne contient pas d'acts ou de zones, vérifiez le Guide <b>{ActsGuide.identity.name}</b><br/>Fichier: <b>{ActsGuide.identity.filename}</b>`</p>
}
